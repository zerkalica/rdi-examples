...
var createTodoModel = (function () {
  var onChanges = [];

  function inform() {
    // requestAnimationFrame(_inform)
...
var TodoHeader = function (_Component) {
  inheritsLoose(TodoHeader, _Component);
  ...
  function TodoHeader() {
    ...
    return (_temp = _this = _Component.call.apply(_Component, [this].concat(args)) || this, _this.handleKey = function (e) {
      if (e.keyCode !== ENTER_KEY) return _this;
      e.preventDefault();
  ...
  TodoHeader.prototype.render = function render$$1(_ref, _ref2) {
...
var ALL_TODOS$1 = 'all';
var ACTIVE_TODOS$1 = 'active';
var COMPLETED_TODOS$1 = 'completed';
var TodoFooter = (function (_ref) {
  ...
  return lom_h("footer", {
    ...
    href: "/",
    "class": {
      selected: nowShowing === ALL_TODOS$1
    }
  }, "All")), "\xA0", lom_h("li", null, lom_h("a", {
    href: "/active",
    "class": {
      selected: nowShowing === ACTIVE_TODOS$1
    }
  }, "Active")), "\xA0", lom_h("li", null, lom_h("a", {
    href: "/completed",
    "class": {
      selected: nowShowing === COMPLETED_TODOS$1
    }
...
var TodoItem = function (_Component) {
  inheritsLoose(TodoItem, _Component);
  ...
  function TodoItem() {
    ...
    return (_temp = _this = _Component.call.apply(_Component, [this].concat(args)) || this, _this.handleSubmit = function () {
      ...
      var _this$props5 = _this.props,
          todo = _this$props5.todo,
          onDestroy = _this$props5.onDestroy;
      onDestroy(todo);
    }, _this._setText = function (e) {
      _this.setState({
  ...
  // 	if (node) node.focus();
  // }
  TodoItem.prototype.render = function render$$1(_ref, _ref2) {
...
var App = function (_Component) {
  ...
  function App() {
    ...
    return (_temp = _this = _Component.call.apply(_Component, [this].concat(args)) || this, _this.model = createTodoModel(), _this.state = {
      todos: _this.model.todos,
  ...
  App.prototype.componentWillMount = function componentWillMount() {
    ...
    this.model.subscribe(function (state) {
      _this2.state.todos = state.todos;

      _this2.forceUpdate(); // this.setState({ todos: state.todos });

    });
  };

  App.prototype.render = function render$$1(_ref2, _ref3) {
    var _this3 = this;

    objectDestructuringEmpty(_ref2);
    var _ref3$nowShowing = _ref3.nowShowing,
        nowShowing = _ref3$nowShowing === undefined ? ALL_TODOS : _ref3$nowShowing,
        todos = _ref3.todos,
        newTodo = _ref3.newTodo,
    ...
    return lom_h("div", null, lom_h(TodoHeader, {
      addTodo: this.model.addTodo
      ...
      return lom_h(TodoItem, {
        key: todo.id,
        todo: todo,
        onToggle: _this3.model.toggle,
        onDestroy: _this3.model.destroy,
        ...
        onSave: _this3.save,
        onCancel: _this3.reset
      });
    }))) : null, activeTodoCount || completedCount ? lom_h(TodoFooter, {
...
global$1['lom_h'] = h;
render(lom_h(App, null), document.getElementById('todoapp'));
